                    ...
                    <div class="pure-u-1 main">
                        ...
                        <h1 class="seller-title">
                            ...
                            <div class="seller-title-head-more">
                                <a class="ui-button ui-button-morange view-ShowBrandBoxBtn" href="goAddUCPost.do">
...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("getUserCirclePostListCount.do", "getUserCirclePostListData.do?randquery="+rand,pageSize);
		}
	}
	...
	function installPage() {
		...
		$("#body").append(
                ...
                "<td>"+statusStr+"</td>"+
                "<td class='ui-table-action'><a target='' href='goUpdateUCPost.do?userCirclePostPojo.id="+this.id+"'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target='' href='delUCPost.do?userCirclePostPojo.id="+this.id+"' onclick='javascript:return p_del()'>删除</a></td>"+
                "</tr>"
                );
	}
	//分页展现页面函数 
	$(function() {
		//首次要初始化分页
		var rand=Math.random() * ( 100000 + 1);
		MAOWU.page.init(<s:property value="page.rowCount"/>,"getUserCirclePostListData.do?randIni="+rand,pageSize);
