...
<body>
    <div class="wraper">
    	<!-- <div class="w-title">
    		<h3 class="title">${userMakerThemePojo.specialName}</h3>
    		<div class="info"></div>
    	</div> -->

    	<div class="w-img">
    		<div class="img"><img src="<%=request.getContextPath() %>/upfiles/userMakerTheme/${userMakerThemePojo.banner}" /></div>
    		<div class="info">${userMakerThemePojo.content}</div>
    	</div>
    	
    	<div id="w-btn" class="w-btn">
    		<a href='{"type":"age","value":"${fn:trim(userMakerThemePojo.ageType)}"}'>${userMakerThemePojo.ageTypeStr}</a> 
    		<a href='{"type":"skill","value":"${fn:trim(userMakerThemePojo.skillType)}"}'>${userMakerThemePojo.skillTypeStr}</a> 
    		<a href='{"type":"product","value":"${fn:trim(userMakerThemePojo.productType)}"}'>${userMakerThemePojo.productTypeStr}</a> 
    		<a href='#'>${userMakerThemePojo.optionTypeStr}</a> 
    	</div>
    </div>
