				...
				<form action="doInformationPerfectWeb.do" method="post" id="from1" enctype="multipart/form-data" class="ui-form">
					...
					<fieldset>
						...
						<div class="ui-form-item">
							...
							<input type="text" name="manufacturer.companyPhone"  value="${manufacturerPojo.companyPhone}" class="ui-input" id="ticketName">
							<div id="companyPhone_mgId"></div><font color="red">请填写您入驻公司的注册电话或办公电话。</font>
						</div>
						<div class="ui-form-item">
							<label for="" class="ui-label"> 公司传真：</label>
							<input type="text" name="manufacturer.fax"  value="${manufacturerPojo.fax}" class="ui-input" id="ticketName">
						...
						<div class="ui-form-item">
							...
							<%-- <input type="text" name="manufacturer.brand"  value="${manufacturer.brand}" class="ui-input" id="ticketName">
							 --%><textarea name="manufacturer.brand" class="ui-input" rows="5">${manufacturerPojo.brand}</textarea>
						...
						<div class="ui-form-item">
							...
							<%-- <input type="text" name="manufacturer.scopeBusiness"  value="${manufacturer.scopeBusiness}" class="ui-input" id="ticketName">
							 --%><textarea name="manufacturer.scopeBusiness" class="ui-input" rows="5">${manufacturerPojo.scopeBusiness}</textarea>
						...
						<div class="ui-form-item TaxRegistrationCertificate ">
							...
							<div class="uploadify">
								...
								<input type="file" accept="image/png,image/gif,image/jpg,image/jpeg" class="uploadPreview_imgfile" name="upfile" id="upfileBox">
							</div>
						</div>
						<div class="ui-form-item">
...
tt.vf.req.add(/* namead, */company,legalPerson,companyPhone,fax,brand,scopeBusiness,contact,duty,QQ,email,cPhone,sArea,sAddress/* ,image1BeginDate,image1EndDate */);
...
$(document).ready(function() {
	...
	if("${userCertificatesPhotoPojo.image6}" != null){
		var url = path+"${userCertificatesPhotoPojo.image6}";
		var _this = $("#imageBox6");
		_this.siblings(".uploadPreview_img").find("img").attr("src", url);
		_this.siblings(".uploadPreview_img").show();
		_this.siblings(".uploadPreview_note").hide();
	...
	$("#sbutton").click(function(){
		...
		if($("input[name='image6']").val() == ""){
			$("#color6").attr("class","red");
			$("#image6_mgId").html("<img src='<s:i18n name="sysconfig"><s:text name="seller_dns" /></s:i18n>/js/testJSP/js/validate/css/img/error.png' /> 合同照 为必须项。");
			v6 = false;
		}else{
			$("#color6").attr("class","green");
			$("#image6_mgId").html("<img src='<s:i18n name="sysconfig"><s:text name="seller_dns" /></s:i18n>/js/testJSP/js/validate/css/img/success.png' /> OK!");
			v6 = true;
		}
