...
<body>
	<div class="sub_wrap">
		...
		<form action="productCommentHg.do" method="post" id="sysform">

			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						<td align="right">商品名称：</td>
						<td><label><input type="text" name="productCommentPojo.userName"
								value=""></label></td>
...
function query() {
	if(tt.validate()){
		...
		queryData("getProductCommentCountHg.do", "productCommentAllListHg.do?randquery="+rand);
	}
}
...
function setEndDay() {
	...
	function installPage() {
		$("#body").append(
				"<tr><td>"+ this.productName + 
		        "</td><td>" + this.scoreTotal+
		        "</td><td>" + this.scoreProduct+
		        "</td><td>" + this.scoreService+
		        "</td><td>" + this.scoreSspeed+
		        "</td><td>" + this.scoreEspeed+
		        "</td><td>" + this.scoreEservice
		        + "</td></tr>");
	}
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"productCommentAllListHg.do?randIni="+rand);
