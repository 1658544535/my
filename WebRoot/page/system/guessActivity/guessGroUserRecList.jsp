...
<body>
	<div class="sub_wrap">
		...
		<form action="#" method="post" id="sysform">
			<div id="search_show" style="">
				...
				<input type="hidden" name="id" value="${id}"  />
					<tr>
						<td align="left"><input type="text" name="keywords" placeholder="用户昵称或编号"/></td>
		...
		<div class="h15"></div>
		<div>
			<s:if test="panduan!=1"><a class="Add_btn" href="goAddGrouponUserRecord.do" >新增</a></s:if>
			<a class="Add_btn" onclick="submitForm();">发放优惠券</a>
			<%--
			...
			--%>
			<form action="grantCoupon.do?activityId=${id}&productId=${productId}" id="idform" method="post">
...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("guessGroUserRecCount.do", "guessGroUserRecList.do?randquery="+rand+"&groActId="+"${id}");
		}
	}
	// 提交表单
	function submitForm(){
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init(${page.rowCount}, "guessGroUserRecList.do?randIni="+rand+"&groActId="+"${id}");	
