			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						...
						<td align="left"><input type="text" name="keywords" id="keywords" placeholder="商品货号或商品名称"/></td>
...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("selectGuessProductCount.do", "selectGuessProductList.do?randquery="+rand);
		}
	}
	...
	function installPage() {
		$("#body").append(
				...
				"<td><a class='edit_btn' onclick='replaceProduct("+this.productId+");'>替换</a></td>"
				</s:if>
				);
	}
	/**
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init(${page.rowCount}, "selectGuessProductList.do?randIni="+rand);	
