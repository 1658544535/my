...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("selectFreeDrawProductCount.do", "selectFreeDrawProductList.do?randquery="+rand);
		}
	}
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init(${page.rowCount}, "selectFreeDrawProductList.do?randIni="+rand);	
