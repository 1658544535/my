...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a>退货管理</a> &gt; <a href="userOrderRefundManage.do?refundStatus=1">退货申请</a> &gt; <a
				href="#">详情</a>
		</div>
		<div class="h15"></div>
		<div>
				...
				<%-- <form action="updateOrderRefund.do?refundStatus=1" method="post" id="from1">
		...
		<!--	<form action="updateOrderRefund.do?refundStatus=1" method="post" id="from1">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<s:if test="userOrderRefundPojo.images2!=''"><img src='<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/orderRefund/${userOrderRefundPojo.images2}'  height='100px'></s:if>
						<s:if test="userOrderRefundPojo.images3!=''"><img src='<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/orderRefund/${userOrderRefundPojo.images3}'  height='100px'></s:if></td>
					</tr>
