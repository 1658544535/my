...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">拼得客任务</a> &gt; <a href="#">修改</a>
		</div>
		<div class="h15"></div>
		<div>
		<form action="updatePindekeTaskProduct.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.num" id="num" value="${grouponActivityPojo.num}" onchange="setCommission()"/>（每个团的成团人数）
					</div>
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.price" id="price" value="${grouponActivityPojo.price}" onchange="setCommission()"/>
					</div>
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.rebateRatio" id="rebateRatio" value="${grouponActivityPojo.rebateRatio}" onchange="setCommission()"/>（单位：%，只需填写数字即可）
					</div>
				...
				<%-- <div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.restrictionNum" id="grouponActivityPojo.restrictionNum" value="${grouponActivityPojo.restrictionNum}"/>（如果不限购则设置为：0）
					</div>
