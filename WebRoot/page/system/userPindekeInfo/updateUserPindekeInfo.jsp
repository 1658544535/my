...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">拼得客-用户信息表管理</a> &gt; <a href="#">编辑</a>
		</div>
		<div class="h15"></div>
		<div>
			<form action="updateUserPindekeInfo.do" method="post" id="from1" enctype="multipart/form-data">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table"> 
					...
					<tr>
						...
						<td><input type="text" name="userPindekeInfoPojo.name" id="userPindekeInfoPojo.name" value="${userPindekeInfoPojo.name}" /></td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">手机号码：</td>
						<td><input type="text" name="userPindekeInfoPojo.phone" id="userPindekeInfoPojo.phone" value="${userPindekeInfoPojo.phone}" /></td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">身份证号码：</td>
						<td><input type="text" name="userPindekeInfoPojo.cardNo" id="userPindekeInfoPojo.cardNo" value="${userPindekeInfoPojo.cardNo}" /></td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">推广渠道：</td>
						<td><input type="text" name="userPindekeInfoPojo.extendChannel" id="userPindekeInfoPojo.extendChannel" value="${userPindekeInfoPojo.extendChannel}" /></td>
					</tr>
					<tr>
					...
					<div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        ...
                                        <div class="uploadPreview_img"> <img style="width:120px;height:120px;" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/userpindeke/${userPindekeInfoPojo.extendImg1}"/></div>
...
b. 大小100k
				...
				<tr>
					...
					<div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        ...
                                        <button class="uploadPreview_note"style="width:120px;height:120px;line-height:120px;display: none;">
                                        <i class="iconfont">&#xf00f7;</i>添加图片</button>
                                        <div class="uploadPreview_img"> <img style="width:120px;height:120px;" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/userpindeke/${userPindekeInfoPojo.extendImg2}"/></div>
...
b. 大小100k
				...
				<tr>
					...
					<td><div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        ...
                                        <button class="uploadPreview_note"style="width:120px;height:120px;line-height:120px;display: none;">
                                        <i class="iconfont">&#xf00f7;</i>添加图片</button>
                                        <div class="uploadPreview_img"> <img style="width:120px;height:120px;" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/userpindeke/${userPindekeInfoPojo.extendImg3}"/></div>
...
b. 大小100k
				...
				<tr>
					...
					<td><div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        ...
                                        <button class="uploadPreview_note"style="width:120px;height:120px;line-height:120px;display: none;">
                                        <i class="iconfont">&#xf00f7;</i>添加图片</button>
                                        <div class="uploadPreview_img"> <img style="width:120px;height:120px;" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/userpindeke/${userPindekeInfoPojo.extendImg4}"/></div>
...
b. 大小100k
				...
				<tr>
					...
					<td><div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        ...
                                        <button class="uploadPreview_note"style="width:120px;height:120px;line-height:120px;display: none;">
                                        <i class="iconfont">&#xf00f7;</i>添加图片</button>
                                        <div class="uploadPreview_img"><img style="width:120px;height:120px;"  src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/userpindeke/${userPindekeInfoPojo.extendImg5}"/></div>
