...
<body>
	<div class="sub_wrap">
		<div class="s_nav"><a href="#">掌上秒杀参团用户列表</a> &gt; <a href="#">掌上秒杀参团用户列表管理</a></div>
		...
		<form action="#" method="post" id="sysform">
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						<td align="left"><input type="text" name="keywords" placeholder="用户昵称、编号、订单号"/></td>
...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("seckillGroUserRecCount.do?grouponUserRecordPojo.attendId=${grouponUserRecordPojo.attendId}", "seckillGroUserRecList.do?grouponUserRecordPojo.attendId=${grouponUserRecordPojo.attendId}&randquery="+rand+"");
		}
	}
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init("${page.rowCount}", "seckillGroUserRecList.do?grouponUserRecordPojo.attendId=${grouponUserRecordPojo.attendId}&randIni="+rand+"");	
