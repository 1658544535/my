...
<body>
	<div class="sub_wrap">
		<div class="s_nav"><a href="#">掌上秒杀团列表管理</a> &gt; <a href="#">掌上秒杀团列表管理</a></div>
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						...
						<td align="left">
							<select name="grouponUserRecordPojo.activityStatus" id="grouponUserRecordPojo.activityStatus"  class="floatLeft">
								<option value="">全部</option>
		...
		<div>
			...
			--%>
			<!--<a class="comment_btn" href="goActivityProductComment.do?activityProductCommentPojo.activityId=${grouponUserRecordPojo.id}">评论审核</a>-->
...
var pagecount = "${page.rowCount}"; 
	...
	function query() {
		if(tt.validate()){
			...
			queryData("seckillGroRecCount.do?grouponUserRecordPojo.id=${grouponUserRecordPojo.id}", "seckillGroRecList.do?grouponUserRecordPojo.id=${grouponUserRecordPojo.id}&randquery="+rand+"");
		}
	}
	...
	function installPage() {
		...
		$("#body").append(
				...
				"<td><a class='edit_btn' href='goSeckillGroUserRec.do?grouponUserRecordPojo.attendId="+this.id+"'>查看</a></td>"+
				"</tr>"
				);
	}
	/**
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init("${page.rowCount}", "seckillGroRecList.do?grouponUserRecordPojo.id=${grouponUserRecordPojo.id}&randIni="+rand+"&groActId="+"${id}");	
