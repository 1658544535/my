...
.top img{width:100%;}
.top_info{margin:0 4%;font-size:16px;line-height:28px;color:#727171!important;text-align: justify;}
...
<div class="wrapper">
    ...
    <s:iterator value="sceneProductPojos1" status='item'>
    	<li><a href='{"type":"1","sceneId":"${scenePojo.activityId}","productId":"${productId}","detail":"1"}'>
            ...
            <img src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>upfiles/product/${image}" />
            <div class="top_price">
    ...
    <s:iterator value="sceneProductPojos0">
    	...
    	<a href='{"type":"1","sceneId":"${scenePojo.activityId}","productId":"${productId}","detail":"1"}'>
            	<div class="pro_pic"><img src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>upfiles/product/${image}" /></div>
