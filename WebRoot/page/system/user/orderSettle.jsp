...
<body>
	<div class="sub_wrap">
		...
		<form action="orderSettle.do?os=${os}" method="post" id="sysform">
...
function query() {
	if(tt.validate()){
		...
		queryData("getOrderCountSettle.do?os=<s:property value='os'/>&", "orderAllListSettle.do?os=<s:property value='os'/>&randquery="+rand);
	}
}
...
function setEndDay() {
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"orderAllListSettle.do?os=<s:property value='os'/>&randIni="+rand);
