...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">视频管理</a> &gt;<a href="#">新增视频</a></div>
  <div>
  <form action="insertVideo.do" method="post" id="from1" enctype="multipart/form-data">
  <input type="hidden" name="type" id="type" value="${type}">
	...
	<tr><td align="right" class="grey">链接：</td>
	<td>
	<input type="text" name="videoPojo.url" value="${videoPojo.url}" class="floatLeft" />
	<span id="url_msgId"></span>
	</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea rows="10" cols="40" name="videoPojo.remark" class="floatLeft" id="content"></textarea></td>
	</tr>
    </table>
    </form>
  </div>
...
<script>
    var v_name = new tt.Field("标题", "videoPojo.label").setMsgId("label_msgId");    
     var v_url = new tt.Field("链接", "videoPojo.url").setMsgId("url_msgId");
	...
	tt.vf.req.add(v_name,v_url,v_age,v_skill);
    	...
    	$("#channelId").append("");
            $.ajax(
            {
                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < o_msg.length; i++) {
                        var selectedStr = "";
                        if("${videoPojo.type}".indexOf(':'+ o_msg[i].id+':') != -1){
