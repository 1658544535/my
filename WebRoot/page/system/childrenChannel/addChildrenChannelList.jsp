...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">少儿频道</a> &gt;<a href="#">少儿频道设置</a> &gt;<a href="#">新增频道</a></div>
  <div>
  <form action="addChildrenChannelListOk.do" method="post" id="from1" enctype="multipart/form-data">
