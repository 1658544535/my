...
<body>
<div class="sub_wrap">
  <div class="s_nav"><a>系统管理</a> &gt; <a href="store_list.html" >用户角色管理</a> &gt; <a href="#">新增用户角色</a></div>
  <div class="h15"></div>
  <div>	
  <form action="addUserRole.do" method="post" id="from1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table">
      <tr>
      <td align="right" class="grey"  width="15%">角色:</td>
        <td width="35%"><select name="roleId" id="ticketType"  class="floatLeft">
					
					  	<s:iterator value="#request.roleList" id="us">
   	  
                
					<option value="<s:property value="#us.roleId"/>"<s:if test="#us.roleId==%{roleLists.roleId}">selected="selected "</s:if>> <s:property value="#us.roleName"/></option>
        ...
        <td width="35%"><select name="userId" id="ticketType"  class="floatLeft">
						
						   	<s:iterator value="#request.userList" id="us">
   	  
                
					<option value="<s:property value="#us.userId"/>" > <s:property value="#us.userName"/></option>
