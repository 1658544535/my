...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a>资讯信息</a> &gt; <a href="store_list.html">添加信息</a>
		</div>
		<div class="h15"></div>
		<div>
			<form action="addInfo.do?infoPojo.type=${infoPojo.type}" method="post" id="from1"
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
					  ...
					  <td align="right" class="grey" width="15%">内容:</td>
						...
						<textarea rows="5" cols="40" name="infoPojo.content" class="floatLeft" id="content"></textarea>
						<script type="text/javascript">
