...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">专题模块</a> &gt; <a href="#">专题分类</a> &gt; <a href="#">新增</a>
		</div>
		<div class="h15"></div>
		<div>
		<form action="addSpecialType.do" method="post" id="from1" enctype="multipart/form-data">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table">
				<tr>
					<td align="right" class="grey" width="15%">名称：</td>
					<td><input type="text" name="specialTypePojo.name" id="specialTypePojo.name" value="" /></td>
					<td><span id="name_mgId"></span></td>
				</tr>
				<tr>
					<td align="right" class="grey" width="15%">排序：</td>
					<td><input type="text" name="specialTypePojo.sorting" id="specialTypePojo.sorting" value="" /></td>
