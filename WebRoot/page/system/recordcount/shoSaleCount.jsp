...
<body>
	<div class="sub_wrap">
		...
		<!-- 查询开始 -->
		<form action="shopSaleListCount.do" method="post" id="sysform">
			<div id="search_show" style="">
			<input type="hidden" name="userOrderDetailPojo.shopId"
								id="userOrderDetailPojo.shopId" value="${userOrderDetailPojo.shopId}">
...
<script type="text/javascript">
	...
	function query() {
		if (tt.validate()) {
			var rand = Math.random() * (100000 + 1);
			queryData("getShopSaleCount.do", "shopSaleList.do?randquery=" + rand);
		}
	}
