			...
			<form action="" method="post" id="from1">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="35%">${eleorderPojo.orderNo}</td>
						<td align="right" class="grey" width="15%">商品总数量：</td>
						<td width="35%">${eleorderPojo.allnum}</td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">订单原价：</td>
						<td width="35%">${eleorderPojo.allpay}</td>
					...
					<tr>
						...
						<td width="35%">${eleorderPojo.consignee}</td>
					</tr>
					
					<tr>
						<td align="right" class="grey" width="15%">收货地址:</td>
						<td width="35%">${eleorderPojo.consigneeAddress}</td>
						<td align="right" class="grey" width="15%">收货人电话:</td>
						<td width="35%">${eleorderPojo.consigneePhone}</td>
					</tr>
				</table>
		...
		<c:if test="${orderDetails.size()!=0}">
			<div>
				<table width="100%" border="1" class="Info_list_table">
					...
					<c:forEach items="${eleorderPojos}" var="product">
						<tr> 
						<td align="center">${product.productName}</td>
						<td align="center">${product.pay}</td>
