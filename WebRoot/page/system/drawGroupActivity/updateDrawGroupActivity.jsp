...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">0.1夺宝表管理</a> &gt; <a href="#">修改</a>
		</div>
		<div class="h15"></div>
		<div>
		<form action="updateDrawGroupActivity.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.num" id="grouponActivityPojo.num" value="${grouponActivityPojo.num}"/>（每个团的成团人数）
					</div>
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.sorting" id="grouponActivityPojo.sorting" value="${grouponActivityPojo.sorting}"/>（数字越大，排列越前）
					</div>
