...
<body>
	<div class="sub_wrap">
		<div class="s_nav"><a href="#">0.1夺宝团列表管理</a> &gt; <a href="#">0.1夺宝团列表管理</a></div>
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						...
						<td align="left"><input type="text" name="drawGrouponRecordPojo.keywords" placeholder="团编号"/></td>
						<td align="left">团状态:</td>
						<td align="left">
							<select name="drawGrouponRecordPojo.groupStatus" id="drawGrouponRecordPojo.groupStatus"  class="floatLeft">
						...
						<td align="left">
							<select name="drawGrouponRecordPojo.activityStatus" id="drawGrouponRecordPojo.activityStatus"  class="floatLeft">
								<option value="">全部</option>
		...
		<div>
			...
			--%>
			<a class="comment_btn" href="goActivityProductComment.do?activityProductCommentPojo.activityId=${drawGrouponRecordPojo.id}">评论审核</a>
...
var pagecount = "${page.rowCount}"; 
	...
	function query() {
		if(tt.validate()){
			...
			queryData("drawGroupGroRecCount.do?drawGrouponRecordPojo.id=${drawGrouponRecordPojo.id}", "drawGroupGroRecList.do?drawGrouponRecordPojo.id=${drawGrouponRecordPojo.id}&randquery="+rand+"&groActId="+"${id}");
		}
	}
	...
	function installPage() {
		...
		$("#body").append(
				...
				"<td><a class='edit_btn' href='goDrawGroupGroUserRec.do?drawGrouponRecordPojo.attendId="+this.id+"'>查看</a></td>"+
				"</tr>"
				);
	}
	/**
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init("${page.rowCount}", "drawGroupGroRecList.do?drawGrouponRecordPojo.id=${drawGrouponRecordPojo.id}&randIni="+rand+"&groActId="+"${id}");	
