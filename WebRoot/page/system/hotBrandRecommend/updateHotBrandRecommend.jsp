...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
			<form action="updateHotBrandRecommend.do?hotBrandRecommendPojo.id=${hotBrandRecommendPojo.id}" method="post" id="from1"
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="35%"><label>${hotBrandRecommendPojo.name}</label><span id="merTitle_msgId"></span></td>
					
					</tr>
					<tr>
						
						<td align="right" class="grey" width="15%">品牌图:</td>
	                    <td><img  class="floatLeft" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/businessCenter/brandDic/${hotBrandRecommendPojo.image}" height="100px"  /></td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">序号:</td>
						<td width="35%"><input type="text" name="hotBrandRecommendPojo.sorting"
							class="floatLeft" id="merNamffe" value="${hotBrandRecommendPojo.sorting}"><span id="merTitle_msgId"></span></td>
