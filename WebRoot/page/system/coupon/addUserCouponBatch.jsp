...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">商品优惠管理</a> &gt;<a href="#">批量新增优惠券</a></div>
  <div>
  <form action="insertUserCouponBatch.do" method="post" id="from1" enctype="multipart/form-data">
    ...
    <tr>
      ...
      <tr>
		...
		<td>
			<input type="text" name="userCouponPojo.num" value="" id="ticketName">
		</td>
...
<script>
	...
	var num =new tt.Field(" 生成数量 ","userCouponPojo.num").setMsgId("num_mgId");
	tt.vf.req.add(couponId,stat,validStime,validEtime,num);
</script>