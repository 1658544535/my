...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="productManage.do">商品管理</a> &gt; <a href="productStockManage.do?productStockPojo.productId=<s:property value='productStockPojo.productId'/>">商品SKU管理</a> &gt; <a
				href="#">新增商品SKU</a>
		</div>
	...
	<form action="productStockAdd.do" method="post" id="from1" enctype="multipart/form-data">
