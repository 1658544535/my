...
<div class="s_nav"><c:if test="${!empty productPojo}"><a href="#">品牌管理</a> &gt; <a href="#">账户信息</a> &gt;</c:if><a href="#">商品管理</a> &gt; <a href="#">商品信息管理</a></div>
  ...
  <div class="h15"></div>
   <div>
  <c:if test="${!empty productPojo}">  <a href="goproductAdd.do?productPojo.userId=${productPojo.userId}" class="Add_btn">新增商品</a> </c:if>
	...
	function installPage() {
		$("#body").append(
			  ...
			  //"<td>"+ this.minimum + "</td>"+
				...
				"<td>"+ this.weight + "</td>"+
				"<td><a class='edit_btn' href='productImagesManage.do?productImagesPojo.productId="+this.id+"&productImagesPojo.userId="+this.userId+"'>商品图片</a>"+
				...
				"<td><a class='edit_btn' href='productStockManage.do?productStockPojo.productId="+this.id+"'>管理</a></td>"+
				...
				"<a class='edit_btn' href='activityGoodsAdd.do?productId="+this.id +"&timeId="+activityTimePojo.timeId+"'>限时秒杀</a></td></tr>");
	}
