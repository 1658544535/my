...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">信息统计</a> &gt; <a href="#">商品访问信息统计</a>
		</div>
		...
		<form action="productAccessLogHot.do?os=${os}" method="post" id="sysform">
...
function query() {
	if(tt.validate()){
		...
		queryData("getProductAccessLogCountHot.do?os=<s:property value='os'/>&", "productAccessLogAllListHot.do?os=<s:property value='os'/>&randquery="+rand);
	}
}
...
function setEndDay() {
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"productAccessLogAllListHot.do?os=<s:property value='os'/>&randIni="+rand);
