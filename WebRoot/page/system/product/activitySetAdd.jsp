...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
		 <a href="#">活动商品管理</a> &gt;<a href="activitySetManage.do?type=${type}">单品活动管理</a>&gt;<a>添加活动商品</a></div>
		<div class="h15"></div>
		<div>
			<form action="addActivitySetProduct.do?type=${type}" method="post" id="from1" enctype="multipart/form-data">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr class="picdis">
						...
						<td width="35%" id="rec2">
				        <textarea class="floatLeft" rows="6" cols="50" name="activityProductPojo.recommendation" id="activityProductPojo.recommendation"></textarea>
						...
						<td>
							...
							<span id="word2" style="display: none;"><font color="#FF0000">图片尺寸：248*368</font></span>
						</td>
					</tr>
					</table>
			</form>
