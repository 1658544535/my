...
<body>
	<div class="sub_wrap">
		...
		<div>
			...
			<a class="Add_btn" href="goProductTypeThree.do">新增推荐</a></s:if>
...
<script type="text/javascript">
		...
		$("#body")
				.append(
						<!--"<tr><td><input  name='tids' type='checkbox' value="+this.id +"   /></td><td>"-->
								...
								+ this.id
								+ "')>删除</a>"
								+ "<a class='edit_btn' href='goUpdateProductTypeRecommend.do?productTypeRecommendPojo.id="
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"productTypeRecommendAllList.do?randIni=" + rand);
