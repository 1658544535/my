...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">系统管理</a> &gt; <a href="syntheticalDict.do">综合字典管理</a> &gt; <a
				href="#">新增字典</a>
		</div>
	
	<div class="h15"></div>
	<form action="insertSyntheticalDict.do" method="post" id="from1">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
				class="info_table">
				<tr>
        <td align="right" class="grey" width="15%">字典名称:</td>	
        <td width="35%">
        <input type="text" name="syntheticalDict.name"  value="" class="floatLeft" id="ticketName"><span id="namead"></span></td>
      ...
      <tr>
        ...
        <td width="35%">
        <input type="text" name="syntheticalDict.nameEn"  value="" class="floatLeft" id="ticketName"><span id="nameEn"></span></td>
        
        <td align="right" class="grey" width="15%">字典分类:</td>	
        <td width="35%">
        <input type="text" name="syntheticalDict.type"  value="" class="floatLeft" id="ticketName"><span id="type"></span></td>
        
      </tr>
      <tr>
        <td align="right" class="grey" width="15%">字典取值:</td>	
        <td width="35%">
        <input type="text" name="syntheticalDict.value"  value="" class="floatLeft" id="ticketName"><span id="value"></span></td>
           <td align="right" class="grey" width="15%">排序:</td>	
        <td width="35%">
        <input type="text" name="syntheticalDict.sorting"  value="" class="floatLeft" id="ticketName"><span id="sorting"></span></td>
      </tr>
</table>
</form>
		</div>
