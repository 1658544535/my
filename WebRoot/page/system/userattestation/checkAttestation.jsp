...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">采购商账户管理 </a> &gt; <a href="#">店铺认证 </a> &gt; <a href="">审核</a>
		</div>
		<div class="h15"></div>
		<div>
			<form action="verifyUserAttestation.do?type=${type}" method="post" id="from1"
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td align="left">
							<s:property value="userAttestationPojo.userName" />
						</td>
					</tr>
					<tr>
					...
					<tr>
					<td align="right" class="grey" width="15%">3C认证:</td>
					<td width="35%" colspan="3">
					<img src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/attestation/<s:property value="userAttestationPojo.user3cImage"/>" height="200px">
					<span id="shopLongitude_msgIddd2" ></span>
					</td>
				</tr>
				</table>
			</form>
		...
		<div class="Btn_div">
			...
			<input type="button" class="ok_btn" value="审核" id="sbutton" />
		</div>
	</div>
</body>
</html>
