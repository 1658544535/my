...
<div class="sub_wrap">
  ...
  <div class="h15"></div>
  <div>
  <form action="addUserDeductionScoreOk.do" method="post" id="form1" enctype="multipart/form-data">
  ...
  <div class="Btn_div">
  		...
  		<input type="button"  class="ok_btn" value="提交扣分" id="sbutton" onclick="submiting()"/>
  </div>
</div>
