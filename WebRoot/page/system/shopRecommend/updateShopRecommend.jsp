...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">创客管理</a> &gt; <a href="#">店铺推荐</a>&gt; <a href="">编辑店铺推荐</a>
		</div>
		<div class="h15"></div>
		<div>
			<form action="updateShopRecommend.do?shopRecommendPojo.id=${shopRecommendPojo.id}" method="post" id="from1"
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="35%"><label>${shopRecommendPojo.name}</label><span id="merTitle_msgId"></span></td>
					
					</tr>
					<tr>
						
						<td align="right" class="grey" width="15%">店铺logo:</td>
	                    <td><img  class="floatLeft" src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/shop/${shopRecommendPojo.images}" height="100px"  /></td>
					</tr>
					<tr>
						<td align="right" class="grey" width="15%">序号:</td>
						<td width="35%"><input type="text" name="shopRecommendPojo.sorting"
							class="floatLeft" id="merNamffe" value="${shopRecommendPojo.sorting}"><span id="merTitle_msgId"></span></td>
