...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">玩具工厂管理</a> &gt;<a href="#">玩具设置</a> &gt;<a href="#">玩具配件设置</a>&gt;<a href="#">新增玩具配件</a></div>
  <div>
  <form action="insertGameToyParts.do?toyId=${toyId}" method="post" id="from1" enctype="multipart/form-data">
  <input type="hidden" name="type" id="type" value="${type}">
	...
	<td>
	<input type="text" name="gameToyPartsPojo.probability" value="100" class="floatLeft" />
