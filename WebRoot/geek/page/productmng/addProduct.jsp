		...
		<div class="container" style="width:100%">
			...
			<div class="tab-content">
			    <div role="tabpanel" class="tab-pane active" id="info">
					<div>
		<form  class="ui-form product-add-form" action="productAddGeekWeb.do" method="post" id="from1" enctype="multipart/form-data" onkeydown="if(event.keyCode==13)return false;">		
