		...
		<div class="container" style="width:100%">
			...
			<div class="tab-content">
			    <div role="tabpanel" class="tab-pane active" id="info">
					<div>
						<form action="addGeekTheme.do" id="form1" accept-charset="utf-8" class="ui-form p50 view-MartShowForm clone-MartShowForm" method="post"  enctype="multipart/form-data">
							<input type="hidden" id="geekThemeId"/>
							<input type="hidden" value="1" name="userMakerThemePojo.version"/>
	                        <div class="apply-box">
	                            ...
	                            <div class="ui-form-item">
	                                ...
	                                <div class="fl picInfo">
	                                    <div class="uploadify">
	                                        ...
	                                        <input type="file" accept="image/png,image/gif,image/jpg,image/jpeg" class="uploadPreview_imgfile" name="banner" id="bannerId" value=""/>
	                                    
	                                    </div>
	                                    <div id="message" name="message" class="talentErrMsg" style="display:none;">
	                                      	主图不允许为空
	                                    </div>
	                                    <p><span id="msg_banner"></span></p>
	                                </div>
	                            </div>
	                        </div>
	                    </form>
			    ...
			    <div role="tabpanel" class="tab-pane container-fluid" id="album">
			    	<iframe src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/tzmeditor/index.html" id="iframepage" name="iframepage" frameBorder=0 width="100%" onLoad="reinitIframeEND();"id="iframepage" name="iframepage" frameBorder=0 scrolling=no width="100%" onLoad="reinitIframeEND();"></iframe>
			    </div>
			</div>
		</div>
...
<script> 
var phoneData="";
var url="addGeekThemeTemplatePageData.do";
...
window.onload = function(){
	 ...
	 $("#albumLi").click(function(){
		 ...
		 if(tt.validate()){
			 //alert(2);
			//判断是否添加了专题基本信息
			 if($("#geekThemeId").val() == null || $("#geekThemeId").val() == 0 || $("#geekThemeId").val() == ""){
				//alert(3);
				//提交表单
	    		$("#form1").ajaxSubmit({
	    			type: 'post', 
	                ...
	                success: function(data) {
	                    ...
	                    if(data == null){
	                    	...
	                    	$("#infoLi").find("a").click();
	                    	alert("未能查询到该用户的创客品牌信息，请向后台技术人员咨询！");
	                    	return false;
	                    }else if(data == "noImg"){
	                    	$("#infoLi").find("a").click();
	                    	alert("专题主图不能为空！");
	                    	...
	                    	url="addGeekThemeTemplatePageData.do?geekThemeId="+data;
	                    	$("#geekThemeId").val(data);
	                    	$("#next").hide();
	                    }
	                }
	    		});
