		...
		$.ajax(
		{
			...
			success: function (msg) {
				...
				for (var i = 0; i < o_msg.length; i++) {
					$("#ageType").append("<option value=" + o_msg[i].value + ">" + o_msg[i].name + "</option>");
				}
        ...
        <div id="content" class="wrapper">
            <div class="pure-g admin-wrapper">
                <div class="pure-u-1 main">
                    ...
                    <form action="addGeekShopWeb.do" accept-charset="utf-8" class="ui-form p50" method="post" id="from1" enctype="multipart/form-data">
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <input class="ui-input" id="userMakerShopPojo.shopName" name="userMakerShopPojo.shopName" type="text" value="" />
                            </div>
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <textarea name="userMakerShopPojo.detailedAddress" class="ui-textarea" placeholder="不需要重复填写省市区，必须大于5个字符，小于120个字符"></textarea><div id="detailedAddress_mgId"></div>
                            </div>
                        </div>
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <input class="ui-input" name="userMakerShopPojo.phone" type="text" value="" />
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <input class="ui-input" name="userMakerShopPojo.servicePhone" type="text" value="" />
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <input class="ui-input" name="userMakerShopPojo.alipayAccount" type="text" value="" />
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <input class="ui-input" name="userMakerShopPojo.alipayName" type="text" value="" />
                            ...
                            <div id="store_company" class="store-tab-item">
                                <div class="apply-box">
                                    <div class="ui-form-item">
                                        ...
                                        <input class="ui-input" id="userMakerShopPojo.shopTypeName1" name="userMakerShopPojo.shopTypeName1" type="text" value="" />
                            ...
                            <div id="store_pc" class="store-tab-item">
                                <div class="apply-box">
                                    <div class="ui-form-item">
                                        ...
                                        <input class="ui-input" id="userMakerShopPojo.shopTypeName2" name="userMakerShopPojo.shopTypeName2" type="text" value="" />
                                ...
                                <div class="apply-box">
                                    <div class="ui-form-item">
                                        ...
                                        <input class="ui-input" name="userMakerShopPojo.shopTypeUrl" type="text" value="" />
