...
<div class="shopping_Cart">
    ...
    <input name="outTradeNo" id="outTradeNo" value="<s:property value='out_trade_no'/>" class="inputText" type="hidden" >
    <input name="cbody" id="cbody" value="<s:property value='body'/>" class="inputText" type="hidden" >
    <input name="totalfee" id="totalfee" value="<s:property value='hCartPrice'/>" class="inputText" type="hidden" >
	        <div class="osBox">        
	...
	<div class="order_information_box">
		<div class="order_information_con">
			...
			<ul class="wlxx_detail">
				<li>收货人：<s:property value='consignee'/></li>
				<li>收货地址：<s:property value='address'/></li>
				<!--  <li>收货邮编：<s:property value='orderDetailConfirm.productName'/></li>  -->
				<li>联系电话：<s:property value='phone'/></li>
				<li>送货方式：<s:property value='consigneeTypeName'/></li>
			</ul>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="shopping_Cart-table" style="margin-top:15px; width:1155px; margin-bottom:15px;">
			 ...
			 <s:iterator value="outOrderList">
		    	   <tr>
						<td colspan="2" class="shopping_Cart-table-title">订单号：<s:property value='orderNo'/></td>
			          	<td colspan="2" class="shopping_Cart-table-title"></td>
			          	<td class="shopping_Cart-table-title"></td>
			          	<td class="shopping_Cart-table-title"><div align="left"></div></td>
			          	<td class="shopping_Cart-table-title"><div align="left"></div></td>
						<td class="shopping_Cart-table-title"><div align="left"></div></td>
			          	<td class="shopping_Cart-table-title"></td>
					</tr>
			       ...
			       <s:iterator value="cartList">
			        <tr>
			        	<td colspan="2" class="shopping_Cart-table-txt01" style="border-bottom:none;"><span class="shopping_Cart-table-txt01-Pic"><a href='goProductDetail.do?productPojo.id=<s:property value='productId'/>'><img src="/upfiles/product/<s:property value='productImage'/>" alt="" width="79" height="80" /></span></td>
			            ...
			            <td class="shopping_Cart-table-txt06" style="border-bottom:none;"><div align="left" style="margin-left:10px;" id="sum">¥<s:property value='allStockPrice'/></div></td>
			        </tr>
      			    </s:iterator>     
      			   <tr>
			        	<td colspan="2" class="shopping_Cart-table-title" style="background:none; border-top:1px solid #dfdfdf;"></td>
			          	...
			          	<td class="shopping_Cart-table-title" style="background:none;border-top:1px solid #dfdfdf;"></td>
						<td class="shopping_Cart-table-title" style="background:none;border-top:1px solid #dfdfdf;"><div align="left">订单金额：<span style="color:#FF0000;">¥<s:property value='allPrice'/></span></div></td>
			          	<td class="shopping_Cart-table-title" style="background:none;border-top:1px solid #dfdfdf; " align="center"><s:if test="consigneeType==2">物流费：<span style="color:#FF0000;">¥0.0</s:if><s:elseif test="espressPrice ==0.00">包邮</s:elseif><s:else>物流费：<span style="color:#FF0000;">¥<s:property value='espressPrice'/></span></s:else></td>
			          	<td class="shopping_Cart-table-title" style="background:none;border-top:1px solid #dfdfdf; ">总金额：<span style="color:#FF0000;">¥<s:property value='factPrice'/></span></td>
			        </tr>
			   </s:iterator>     
		  ...
		  <p class="osp-pay">
		  <span style="font-size:18px;">共计：<font color="#FF0000">¥&nbsp;<s:property value="hCartPrice"/></font></span>&nbsp;&nbsp;&nbsp;&nbsp;
