...
<div class="register-title">
	<div class="register-txt">淘竹马玩具分销平台|<span class="register-txt02">修改我的收货地址</span></div>
</div>

<div class="register-form">
	<!--  <div class="apply-form-title">收货地址信息</div>	-->
	<form action="updateDeliveryAddressWeb.do" method="post" id="from1">
		...
		<input name="deliveryAddressPojo.id" id="sysDictId" value="<s:property value='deliveryAddressPojo.id'/>" class="inputText" type="hidden" >
		<input name="cidsStr" id="cidsStr" value="${cidsStr}" class="inputText" type="hidden" >
	        <tr>
	        	<td class="register-form-tableTxt">省 </td>
	            <td>
	             	&nbsp;&nbsp;
	             	<select id="province" name="deliveryAddressPojo.province" class="register-form-tableInput" ><s:property value='province'/></select>
	            </td>
	        </tr>
	        <tr>
	        	<td class="register-form-tableTxt">城市 </td>
	            <td>
	             	&nbsp;&nbsp;<select id="city" name="deliveryAddressPojo.city" class="register-form-tableInput" ><s:property value='city'/></select>
	            </td>
	        </tr>
	        <tr>
	        	<td class="register-form-tableTxt">区域 </td>
	            <td>
	             	&nbsp;&nbsp;<select id="area" name="deliveryAddressPojo.area" class="register-form-tableInput" ><s:property value='area'/></select>
	            </td>
        	</tr>
        	<tr>
	        	<td class="register-form-tableTxt">收货人</td>
	            <td><input name="deliveryAddressPojo.consignee" type="text" class="register-form-tableInput" value="<s:property value='deliveryAddressPojo.consignee'/>" style="float: left;" /><span id="consignee"></span></td>
        	</tr>
        	<tr>
	        	<td class="register-form-tableTxt">收货地址</td>
	            <td><input name="deliveryAddressPojo.address" type="text" class="register-form-tableInput" value="<s:property value='deliveryAddressPojo.address'/>" style="float: left;" /><span id="address"></span></td>
        	</tr>
        	<tr>
	        	<td class="register-form-tableTxt">收货人电话</td>
	            <td><input name="deliveryAddressPojo.consigneePhone" type="text" class="register-form-tableInput" value="<s:property value='deliveryAddressPojo.consigneePhone'/>" style="float: left;" /><span id="consigneePhone"></span></td>
        	</tr>
        	<tr>
	        	<td class="register-form-tableTxt">邮编</td>
	            <td>&nbsp;&nbsp;<input name="deliveryAddressPojo.postcode" type="text" class="register-form-tableInput" value="<s:property value='deliveryAddressPojo.postcode'/>" style="float: left;" /><span id="zipCode"></span></td>
        	</tr>
        	<!--  
        	<tr>
	        	<td class="register-form-tableTxt">排序</td>
	            <td>&nbsp;&nbsp;<input name="deliveryAddressPojo.sorting" type="text" class="register-form-tableInput" value="<s:property value='deliveryAddressPojo.sorting'/>" /><span id=""></span></td>
        	</tr>
        	-->
	    </table>
