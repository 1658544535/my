...
<div class="top02-width">
	...
	<div class="search"><input id="searchkey" name="searchkey" type="text" value="<s:property value='searchkey'/>" onfocus="this.value=''" onblur="if(this.value==''){this.value='请简单描述你的问题'}" class="search-input"/><button type="submit" class="search-button" onclick="search()">搜 索</button></div>
	</form>
</div> 
...
<div class="help-nav-width">
	<div class="help-nav">
    	<ul>
            ...
            <li><a href="goFaqWeb.do?typeid=58"><span>常见问题</a></span></li>
...
<div class="faq-width">
    ...
    <div class="faq-R">
        ...
        <div class="faq-R02">
        	<div class="faq-R02-L-second">
                <div class="faq-R02-txt"><s:iterator value="helpList"><a href="helpDetail.do?helpPojo.id=<s:property value='id'/>"><s:property value="title"/></a><span class="faq-R02-line">|</span></s:iterator></div>
            </div>
        </div>
