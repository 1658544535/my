...
function showPopupAdv(B) {
    ...
    this.init = function() {
        ...
        this.totalwidth = parseInt(jQuery("#" + this.pdivId + "").css("width")) * 2 + 1190;
...
function showFullScreenAdv(A) {
    ...
    this.run = function() {
        jQuery("#" + this.divId + "").html("<a class='fade_btn' ></a><div class='fade_border'></div><div class='fade_main'><img class='fade_closed' src='images/dk_ad_closed.png' height='25' width='25'/>");
        ...
        if (E) {
            ...
            if (F.toLowerCase().indexOf(".swf") > 0) {
                ...
                if (F.toLowerCase().indexOf(".jpg") > 0 || F.toLowerCase().indexOf(".jpeg") > 0 || F.toLowerCase().indexOf(".gif") > 0 || F.toLowerCase().indexOf(".png") > 0) {
                    if (H == "" || H.length < 1) {
                        I = "<a href='" + D + "' onmousedown=\"return ttclick(this,'tracefrom=" + H + "');\"><img src='" + F + "' width='" + C + "' height='" + G + "' border='0'></a>"
                    } else {
                        I = "<a href='" + D + "' onmousedown=\"return ttclick(this,'tracefrom=" + H + "');\" onclick=\"ad_c_m('" + H + "');\"><img src='" + F + "' width='" + C + "' height='" + G + "' border='0'></a>"
                    }
                    jQuery("#" + this.divId + " .fade_main").append(I)
                }
            }
...
(function() {
    var U = [{
        ...
        advParam: "ad_bbs_0804hunbo_1190*500",
        advUrl: "images/top_test.jpg",
        advLink: "#",
        advWidth: 1190,
        advType: "7",
        advHeight: 500
