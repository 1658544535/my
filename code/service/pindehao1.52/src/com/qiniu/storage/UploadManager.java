...
public final class UploadManager {
   ...
   * @param token 上传凭证
   */
  public Response put(final byte[] data, final String key, final String token)
   ...
   * @param checkCrc 是否验证crc32
   */
  public Response put(String filePath, String key, String token, StringMap params, String mime,
      boolean checkCrc) throws QiniuException {
   ...
   * @param checkCrc 是否验证crc32
   */
  public Response put(File file, String key, String token, StringMap params, String mime,
      boolean checkCrc) throws QiniuException {
    ...
    ResumeUploader uploader =
        new ResumeUploader(client, token, key, file, params, mime, recorder, recorderKey);
