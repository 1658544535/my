...
public final class Response {
  ...
  private Response(com.squareup.okhttp.Response response, int statusCode, String reqId,
      String xlog, String xvia, String address, double duration, String error, byte[] body) {
  ...
  static Response create(com.squareup.okhttp.Response response, String address, double duration) {
    ...
    return new Response(response, code, reqId, response.header("X-Log"), via(response), address,
        duration, error, body);
  }

  static Response createError(com.squareup.okhttp.Response response, String address,
  ...
  public boolean needRetry() {
    return isNetworkBroken() || isServerError() || statusCode == 406 || statusCode == 200
        && error != null;
  }
