...
public class RefundService extends BaseService {
  ...
  public RefundService() throws IllegalAccessException, InstantiationException,
   ...
   * @throws Exception
   */
  public String jsrequest(RefundReqData refundReqData) throws Exception {

    // --------------------------------------------------------------------
    // 发送HTTPS的Post请求到API地址
    // --------------------------------------------------------------------
    String responseString = sendJSPost(refundReqData);
