...
public class ScanPayQueryReqData {
   ...
   * @throws Exception
   */
  public ScanPayQueryReqData(String transactionID, String outTradeNo, String wxtrade) {
  ...
  /*
   * public String getSdk_version(){ return sdk_version; }
   * 
   * public void setSdk_version(String sdk_version) { this.sdk_version = sdk_version; }
   */
