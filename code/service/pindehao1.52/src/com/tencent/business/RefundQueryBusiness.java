...
public class RefundQueryBusiness {
  ...
  public RefundQueryBusiness() throws IllegalAccessException, ClassNotFoundException,
  ...
  public void run(RefundQueryReqData refundQueryReqData,
    ...
    RefundQueryResData refundQueryResData =
        (RefundQueryResData) Util.getObjectFromXML(refundQueryServiceResponseString,
    ...
    ReportReqData reportReqData =
        new ReportReqData(
            ...
            refundQueryResData.getReturn_code(), refundQueryResData.getReturn_msg(),
            refundQueryResData.getResult_code(), refundQueryResData.getErr_code(),
            refundQueryResData.getErr_code_des(), refundQueryResData.getOut_trade_no(),
            Configure.getIP());
    ...
    if (refundQueryResData.getReturn_code().equals("FAIL")) {
      ...
      if (refundQueryResData.getResult_code().equals("FAIL")) {
        Util.log("出错，错误码：" + refundQueryResData.getErr_code() + "     错误信息："
   ...
   * @throws Exception
   */
  private void getRefundOrderListResult(String refundQueryResponseString) throws Exception {
