...
public class GeetestLib {
  ...
  public void setGtServerStatusSession(HttpServletRequest request, int statusCode) {
    request.getSession().setAttribute(gt_server_status_session_key, statusCode);// set session
  }
  ...
  public void setGtServerStatusSession(HttpServletRequest request, int statusCode,
    ...
    request.getSession().setAttribute(gt_instance_server_status_session_key, statusCode);// set
    // session
  }
  ...
  public static int getGtServerStatusSession(HttpServletRequest request) {
    ...
    Object server_status = request.getSession().getAttribute(gt_server_status_session_key);
  ...
  public static int getGtServerStatusSession(HttpServletRequest request,
    ...
    Object server_status = request.getSession().getAttribute(gt_instance_server_status_session_key);
  ...
  public void setChallengeSession(HttpServletRequest request) {
    request.getSession().setAttribute(gt_challenge_session_key, this.challengeId);
  }
  ...
  public void setGtServerStatusSession(HttpServletRequest request,
      String gt_instance_server_status_session_key) {
    request.getSession().setAttribute(gt_instance_server_status_session_key, this.challengeId);
  }
  ...
  public void getChallengeSession(HttpServletRequest request) {
    this.challengeId = (String) request.getSession().getAttribute(gt_challenge_session_key);
  }
  ...
  public void getChallengeSession(HttpServletRequest request,
      String gt_instance_server_status_session_key) {
    this.challengeId =
        (String) request.getSession().getAttribute(gt_instance_server_status_session_key);
  }
  ...
  public String getFailPreProcessRes() {
    ...
    return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 0,
  ...
  public String getSuccessPreProcessRes() {
    return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 1,
        this.getCaptchaId(), this.getChallengeId());
  }
  ...
  public void saveValidateLog(String challenge, String validate, String seccode, String sdkResult) {
    ...
    String logFormat =
        String.format("date:%s,challenge:%s,validate:%s,seccode:%s,sdkResult:%s", date, challenge,
            validate, seccode, sdkResult);
  ...
  public String failbackValidateRequest(HttpServletRequest request) {
    ...
    gtlog(String.format("encode----challenge:%s--ans:%s,bg_idx:%s,grp_idx:%s", challenge,
        encodeAns, encodeFullBgImgIndex, encodeImgGrpIndex));

    int decodeAns = decodeResponse(this.getChallengeId(), encodeAns);
    int decodeFullBgImgIndex = decodeResponse(this.getChallengeId(), encodeFullBgImgIndex);
    int decodeImgGrpIndex = decodeResponse(this.getChallengeId(), encodeImgGrpIndex);

    gtlog(String.format("decode----ans:%s,bg_idx:%s,grp_idx:%s", decodeAns, decodeFullBgImgIndex,
        decodeImgGrpIndex));
