...
<body>
   ...
   <div>
   <a class="submit_btn" style="float: right;" onclick="window.history.back()"/>退货退款仲裁</a></div>
		...
		$("#body")
				.append(
						"<tr><td><input  name='tids' type='checkbox' value="+this.id +"   /></td><td>"
								...
								+ sum
								+ "</td><td>"
								+ "<img src='<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/orderRefund/"+ this.image + "' height='80px' />"
								+ "</td><td>"
								+ this.refundReason
								+ "</td><td>"
