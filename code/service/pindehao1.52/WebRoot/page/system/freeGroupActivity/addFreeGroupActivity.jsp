...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
		<form action="addFreeGroupActivity.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="Clear"></div>			
				<div class="mar-tb">
					<div style="float: left"><lable>拼团人数 : </lable></div>
...
<script>
	...
	tt.vf.req.add(beginTime,endTime,num,price);
