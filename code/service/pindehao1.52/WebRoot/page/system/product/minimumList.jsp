...
<body>
<div class="sub_wrap">
    <div class="s_nav"><a href="#">商品管理</a> &gt; <a href="#">起订量管理</a></div>
    <div class="Search_control">
		...
		<form action="minimumManage.do" method="post" id="sysform">
...
function query() {
	...
	function installPage() {
		$("#body").append(
				...
				"</td><s:if test="#session.role.roleId!=7"><td><a class='edit_btn' href='goSetMinimum.do?productPojo.id="+this.id +"'>设置起订量</a></td></s:if></tr>");
	}
