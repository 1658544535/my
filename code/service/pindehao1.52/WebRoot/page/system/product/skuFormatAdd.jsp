...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="">sku管理</a> &gt; <a href="">新增sku颜色</a>
		</div>
	...
	<form action="addSkuFormat.do" method="post" id="from1" enctype="multipart/form-data">
		<input type="hidden" name="productSkuLinkPojo.productId" id="productSkuLinkPojo.productId"
						value="${productSkuLinkPojo.productId}"> 
		<div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td><input class="floatLeft" type="text"
						name="skuAttributePojo.value" id="value"> <span id="value_mgId"></span></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right" width="20%" class="grey">状态:</td>
