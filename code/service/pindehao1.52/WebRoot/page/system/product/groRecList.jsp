...
<body>
	<div class="sub_wrap">
		<div class="s_nav"><a href="#">团列表管理</a> &gt; <a href="#">团列表管理</a></div>
...
var pagecount = "${page.rowCount}"; 
	...
	function query() {
		if(tt.validate()){
			...
			queryData("groRecCount.do?gaActivityId=${gaActivityId}&activityType=1", "groRecList.do?gaActivityId=${gaActivityId}&activityType=1&randquery="+rand+"");
		}
	}
	...
	function installPage() {
		...
		$("#body").append(
				...
				"<td><a class='edit_btn' href='goGroUserRecList.do?grouponUserRecordPojo.attendId="+this.id+"'>查看</a></td>"+
				"</tr>"
				);
	}
	/**
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init("${page.rowCount}", "groRecList.do?gaActivityId=${gaActivityId}&activityType=1&randIni="+rand+"");	
