...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
			<form action="addActivityProduct1.do" method="post" id="from1" enctype="multipart/form-data">
			<input type="hidden" name="activityProductPojo.remarks" value="${activityProductPojo.remarks}" id="activityProductPojo.remarks">
			...
			<input type="hidden" name="activityProductPojo.id" value="${activityProductPojo.id}" id="activityProductPojo.id">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="35%"><label class="floatLeft" name="activityProductPojo.productName">${activityProductPojo.productName}<label></td>
						<td align="right" class="grey" width="15%">图片:</td>
						<td width="35%" colspan="2"><img  class="floatLeft" src="/upfiles/product/${activityProductPojo.image}" height="100px"  />
					</tr>
					<tr>
					...
					-->
					<tr><c:if test="${activityProductPojo.type==1}">
						<td align="right" class="grey" width="15%">推荐语:</td>	
						<td width="35%">
