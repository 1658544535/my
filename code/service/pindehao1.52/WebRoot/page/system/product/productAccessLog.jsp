...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">信息统计</a> &gt; <a href="#">商品访问信息记录</a>
		</div>
		...
		<form action="productAccessLog.do" method="post" id="sysform">

			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						<td align="right">用户昵称：</td>
						<td><label><input type="text" name="productAccessLog.userName"
								value=""></label></td>
					...
					<tr>
						...
						<td><label><input type="text" name="productAccessLog.productName"
								value=""></label></td>
					</tr>
...
function query() {
	if(tt.validate()){
		...
		queryData("getProductAccessLogCount.do", "productAccessLogAllList.do?randquery="+rand);
	}
}
...
function setEndDay() {
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"productAccessLogAllList.do?randIni="+rand);
