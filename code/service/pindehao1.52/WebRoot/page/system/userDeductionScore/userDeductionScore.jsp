...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">商家扣分管理</a> &gt; <a href="#">商家扣分信息列表</a></div>
...
function query() {
	if(tt.validate()){
		...
		queryData("userDeductionScoreManageCount.do", "userDeductionScoreManageList.do?randquery="+rand);
	}
}
	...
	function installPage() {
		$("#body").append(
				...
				"<td><font color='red'>"+ this.scoreAll + "</font></td>"+
				"<td>"+ this.statusName + "</td>"+
				"<td>"+ this.createByDate + "</td>"+
				//"<td>"+ this.createByTime + "</td>"+
				"<s:if test="#session.role.roleId!=7"><td>"+
				"<a class='edit_btn' href='userDeductionScoreManageDetails.do?userDeductionScorePojo.suserId="+this.userId+"'>扣分详情</a></td></s:if>");
	}
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"userDeductionScoreManageList.do?randIni="+rand);
