...
<body>
<div class="sub_wrap">
  <div class="s_nav"><a>系统管理</a> &gt; <a href="sysRole.do" >角色管理</a> &gt; <a href="#">新增角色</a></div>
  <div class="h15"></div>
  <div>
  <form action="insertSysRole.do" method="post" id="from1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table">
      <tr>
        <td align="right" class="grey" width="15%">角色名称:</td>	
        <td width="35%">
        <input type="text" name="sysRole.name"  value="" class="floatLeft" id="ticketName"><span id="namead"></span></td>
      ...
      <tr>
        ...
        <td width="35%">
        <input type="text" name="sysRole.nameEn"  value="" class="floatLeft" id="ticketName"><span id="nameEn"></span></td>
        
        <td align="right" class="grey" width="15%">排序:</td>	
        <td >
        <input type="text" name="sysRole.sorting"  value="" class="floatLeft" id="ticketName"><span id="sorting"></span></td>
      </tr>
