...
<body>
	<div class="sub_wrap">
		...
		<form action="sysLoginLogHot.do?os=${os}" method="post" id="sysform">
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					...
					<tr>
						 <td align="right" >活跃人数: </td>
						 <td><span id="activeUser"></span></td>
					</tr>
				</table>
...
function query() {
	if(tt.validate()){
		...
		queryData("getSysLoginLogCountHot.do?os=<s:property value='os'/>&", "sysLoginLogAllListHot.do?os=<s:property value='os'/>&randquery="+rand);
		activeUser();
	}
}
...
function setEndDay() {
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"sysLoginLogAllListHot.do?os=<s:property value='os'/>&randIni="+rand);
...
function activeUser() {
	...
	$.ajax({
		type: "get",
		url: "sysLoginLogAllActiveUser.do?os=<s:property value='os'/>&beganday="+b+"&endday="+e,
		success: function(data){
			$("#activeUser").html(data);
		},
		error: function(){
