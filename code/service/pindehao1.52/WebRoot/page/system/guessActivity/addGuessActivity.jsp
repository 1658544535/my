...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
		<form action="addGuessActivity.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="Clear"></div>			
				<div class="mar-tb">
					<div style="float: left"><lable>价格区间 : </lable></div>
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.priceMin" id="grouponActivityPojo.priceMin" value=""/>
						<input type="text" name="grouponActivityPojo.priceMax" id="grouponActivityPojo.priceMax" value=""/>
				</div>
				<span id="priceMin_mgId"></span><span id="priceMax_mgId"></span>
					</div>
				<div class="Clear"></div>			
				<div class="mar-tb">
					<div style="float: left"><lable>实际价格 : </lable></div>
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.price" id="grouponActivityPojo.price" value=""/>
					</div>
	...
	<div class="Clear"></div>
	<div class="Btn_div" style="text-align: left;padding:0 3% 0 3%;margin-top: 65px;">
	...
	<div class="wrap">
		<div class="popup" style="height:100%">
			...
			<iframe src="goSelectGuessProduct.do" id="iframepage" name="iframepage" frameBorder=0 width="100%"  style="height:100%" onLoad="reinitIframeEND();"></iframe>
		</div>
	</div>
	<!-- 弹出层结束 -->
</body>
...
<script>
	...
	var priceMin =new tt.Field("最低价格","grouponActivityPojo.priceMin").setMsgId("priceMin_mgId");
	var priceMax =new tt.Field("最高价格","grouponActivityPojo.priceMax").setMsgId("priceMax_mgId");
	var price =new tt.Field("实际价格","grouponActivityPojo.price").setMsgId("price_mgId");
	...
	tt.vf.req.add(beginTime,endTime,priceMin,priceMax,price,sorting);
...
<script type="text/javascript">
	...
	function replacePro(id){
        ...
        $.ajax({
            type: "GET",
            url: "findGuessProductById.do?productPojo.id="+id,
            dataType: "json",
            		...
            		if(productObj != null){
            			...
            			tableStr = '<table width="100%" border="0" class="Info_list_table" style="background:#fff">'+
			    						...
			    						'<tr style="height:100px">'+
			    							...
			    							'<td><img src="<s:i18n name="sysconfig"><s:text name="houtai_dns" /></s:i18n>/upfiles/product/'+productObj.image+'"  height="100px"></td>'+
			    						'</tr>'+
			    						'</tbody>'+    
		    						'</table>';
		    			$("#product").empty();
