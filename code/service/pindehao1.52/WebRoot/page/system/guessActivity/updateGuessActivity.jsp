...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
		<form action="updateGuessActivity.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.priceMin" id="grouponActivityPojo.priceMin" value="${grouponActivityPojo.priceMin}"/>
						<input type="text" name="grouponActivityPojo.priceMax" id="grouponActivityPojo.priceMax" value="${grouponActivityPojo.priceMax}"/>
					</div>
