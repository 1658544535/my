...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">0.1夺宝表管理</a> &gt; <a href="#">新增</a>
		</div>
		<div class="h15"></div>
		<div>
		<form action="addDrawGroupActivity.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				<div class="mar-tb">
					...
					<div style="float: left"><input type="text" name="grouponActivityPojo.beginTime" id="grouponActivityPojo.beginTime" value="" 
						...
						至<input type="text" name="grouponActivityPojo.endTime" id="grouponActivityPojo.endTime" value="" 
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.num" id="grouponActivityPojo.num" value=""/>（每个团的成团人数）
				</div>
				<span id="num_mgId"></span>
					</div>
				<div class="Clear"></div>			
				<div class="mar-tb">
					<div style="float: left"><lable>活动排序 : </lable></div>
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.sorting" id="grouponActivityPojo.sorting" value=""/>（数字越大，排列越前）
					</div>
				...
				<div class="mar-tb">
					...
					<div id="product" style="background-color: rgba(242, 242, 242, 1);width: 725px;height: 150px;">
	...
	<div class="wrap">
		<div class="popup">
			...
			<iframe src="goSelectDrawGroupProduct.do" id="iframepage" name="iframepage" frameBorder=0 width="100%" onLoad="reinitIframeEND();"></iframe>
		</div>
	</div>
	<!-- 弹出层结束 -->
</body>
...
<script>
	...
	var sorting =new tt.Field("活动排序","grouponActivityPojo.sorting").setMsgId("sorting_mgId");
	//var productId =new tt.Field("排序价格","grouponActivityPojo.productId").setMsgId("productId_mgId");
	tt.vf.req.add(beginTime,endTime,num,sorting);
...
<script type="text/javascript">
	...
	function replacePro(id){
        ...
        $.ajax({
            type: "GET",
            url: "findDrawGroupProductById.do?productPojo.id="+id,
            dataType: "json",
