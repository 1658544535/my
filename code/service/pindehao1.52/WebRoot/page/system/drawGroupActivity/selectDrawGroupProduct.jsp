...
<body>
	<div class="sub_wrap">
		<div class="s_nav"><a href="#">0.1抽奖表管理</a> &gt; <a href="#">0.1抽奖表管理</a></div>
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						...
						<td align="left"><input type="text" name="drawkeywords" id="drawkeywords" placeholder="商品ID、商品货号或商品名称"/></td>
...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("selectDrawGroupProductCount.do", "selectDrawGroupProductList.do?randquery="+rand);
		}
	}
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init(${page.rowCount}, "selectDrawGroupProductList.do?randIni="+rand);	
