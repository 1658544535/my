...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">活动管理</a> &gt; <a href="#">外链</a>&gt; <a href="">编辑外链</a>
		</div>
		<div class="h15"></div>
		<div>
			<form action="updateExternalLinks.do" method="post" id="from1"
				enctype="multipart/form-data">
				<input type="hidden" name="externalLinksPojo.id"  value="${externalLinksPojo.id}">
