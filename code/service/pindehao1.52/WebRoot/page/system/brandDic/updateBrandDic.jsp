...
<div class="sub_wrap">
  ...
  <div class="h15"></div>
  <div>
  <form action="updateBrandDic.do" method="post" id="from1" enctype="multipart/form-data">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table"> 
  <input type="hidden" name="brandDicPojo.id" id="brandDicPojo.id" value="${brandDicPojo.id}" class="inputText" />
  <tr>
  ...
  <tr>
        ...
        <td width="35%">
        <s:if test="brandDicPojo.logo != null"><img src="/upfiles/businessCenter/brandDic/${brandDicPojo.logo}" height='100px'/></s:if>
   ...
   <tr>
        ...
        <td><select name="brandDicPojo.status" id="brandDicPojo.status"  class="floatLeft">
							<option value="0" <s:if test="brandDicPojo.status==0">selected="selected"</s:if>>未审核</option>
							<option value="1" <s:if test="brandDicPojo.status==1">selected="selected"</s:if>>已审核</option>
				    		</select></td>
