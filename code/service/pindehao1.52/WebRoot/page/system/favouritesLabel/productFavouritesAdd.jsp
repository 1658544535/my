...
<body>
	<div class="sub_wrap">
	<div class="s_nav"><a href="#">标签管理</a> &gt; <a href="favouritesLabelList.do">有你喜欢</a> &gt; <a href="#">添加玩具</a></div>
...
function query() {
	...
	function installPage() {
		...
		$("#body").append(
				...
				"<td>"+ this.weight + "</td>"+
				"<td>"+
				"<a  class='del_btn' href='doProductFavouritesAdd.do?yourFavouritesPojo.id=${yourFavouritesPojo.id}&yourFavouritesPojo.contentType=${yourFavouritesPojo.contentType}&yourFavouritesDetailPojo.productId="+this.id+"&yourFavouritesDetailPojo.activityId="+this.activityId+"'>添加</a></td>"+
				"</tr>");
	}
	$(function() {
		/**
