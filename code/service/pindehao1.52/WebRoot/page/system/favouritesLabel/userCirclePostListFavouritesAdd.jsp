...
function deleteAll(){
		$("#idform").attr("action","doUserCirclePostFavouritesAdd.do").submit();
	}
function checkAll(){
...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">标签管理</a> &gt; <a href="favouritesLabelList.do">有你喜欢</a> &gt; <a href="#">添加</a></div>
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					...
					<tr>
					    ...
					    <td align="right" style="display: none;">审核状态：</td>
						<td style="display: none;"><select name="userCirclePostPojo.status" id="userCirclePostPojo.status"  class="floatLeft">
...
function query() {
	...
	function installPage() {
		$("#body").append(
				...
				"<td>"+ this.statusName + "</td><td><input  name='tids' type='checkbox' value="+this.id +" /><font name='tidsName'>取消</font></td>");
	}
	$(function() {
		/**
		  首次要初始化分页
