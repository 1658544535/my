...
<script type="text/javascript" src="/ueditor1_4_3-utf8-jsp/lang/zh-cn/zh-cn.js"></script></head>
<body>
<div class="sub_wrap">
  <div class="s_nav">
  <a>首页场景设置</a> &gt; 
  ...
  <div class="h15"></div>
  <div>
  <form action="addSceneListOk.do" method="post" id="from1" enctype="multipart/form-data">
    ...
    <tr>
		...
		<td>
			<%-- <img  class="floatLeft" src="/upfiles/scene/${scenePojo.image}" height="100px" /> --%>
