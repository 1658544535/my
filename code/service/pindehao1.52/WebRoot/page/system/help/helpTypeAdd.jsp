...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">帮助/FAQ系统</a> &gt; <a href="helpTypeManage.do">帮助分类管理</a> &gt; <a
				href="#">新增帮助类型</a>
		</div>
	...
	<form action="helpTypeAdd.do" method="post" id="from1">
		<input type="hidden" name="helpTypePojo.pid" id="helpTypePojo.pid"
						value="${helpTypePojo.pid}">
		<div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<td align="right" class="grey" width="15%">状态:</td>
					...
					<td><input class="floatLeft" type="text"
						name="helpTypePojo.name" id="name"> <span
						id="name_mgId"></span></td>
				</tr>
				<tr>
					<td align="right" width="20%" class="grey">排序:</td>
					<td><input class="floatLeft" type="text"
						name="helpTypePojo.sorting" id="sorting"> <span
