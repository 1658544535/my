...
<div class="sub_wrap">
  ...
  <a href="goAddUserBrandList.do">增加用户品牌</a>
  </div>
  <div class="h15"></div>
  <div>
  <form action="addUserBrandListOK.do" method="post" id="from1" enctype="multipart/form-data">
   ...
   <!-- <tr>
	...
	<tr>
		...
		<td width="35%">
        <textarea class="floatLeft" rows="6" cols="50" name="userBrandPojo.brandDisc" id="content"></textarea>
		</td>
		<td><span id="brandDisc_mgId"></span></td>
	</tr>
	<tr>
        ...
        <td><select name="userBrandPojo.grantType" id="userBrandPojo.grantType"  class="floatLeft">
							<option value="1">自主品牌</option>
							<option value="2">独家代理</option>
