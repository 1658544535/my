...
<body>
	<div class="sub_wrap">
		<div class="s_nav">
			<a href="#">财务管理</a> &gt; <a href="#">供应商订单结算</a>
		</div>
		...
		<form action="orderSettleMF.do" method="post" id="sysform">
...
function query() {
	if(tt.validate()){
		...
		queryData("getOrderCountSettleMF.do", "orderAllListSettleMF.do?randquery="+rand);
	}
}
...
function setEndDay() {
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"orderAllListSettleMF.do?randIni="+rand);
