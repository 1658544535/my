...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">商品优惠管理</a> &gt; <a href="#">转发抽奖记录列表</a></div>
			...
			<div id="search_show" style="">
				<table width="100%" border="0" class="Search_table">
					<tr>
						...
						<td><label><input type="text" name="lotteryForwardPojo.userName"
								id="lotteryForwardPojo.userName"
								value=""></label></td>
						<td align="right">转发时间：</td>
						<td>
								<input id="t" name="lotteryForwardPojo.timeDStr" value="" class="Wdate" type="text" 
...
function query() {
	if(tt.validate()){
		...
		queryData("lotteryForwardListCount.do", "lotteryForwardListAll.do?randquery="+rand);
	}
}
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"lotteryForwardListAll.do?randIni="+rand);
