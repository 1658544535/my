...
<body>
	<div class="sub_wrap">
		...
		<div class="h15"></div>
		<div>
		<form action="addFreeDraw.do" method="post" id="from1" enctype="multipart/form-data">
			...
			<div style="padding:0 3% 0 3%">
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.prizeNum" id="grouponActivityPojo.prizeNum" value=""/>
					</div>
				...
				<div class="mar-tb">
					...
					<div style="float: left">
						<input type="text" name="grouponActivityPojo.num" id="grouponActivityPojo.num" value=""/>
					</div>
	...
	<div class="wrap">
		<div class="popup">
			...
			<iframe src="goSelectFreeDrawProduct.do" id="iframepage" name="iframepage" frameBorder=0 width="100%" onLoad="reinitIframeEND();"></iframe>
		</div>
	</div>
	<!-- 弹出层结束 -->
</body>
...
<script>
	...
	tt.vf.req.add(beginTime,endTime,prizeNum,num,price);
