...
<script type="text/javascript">
	...
	function query() {
		if(tt.validate()){
			...
			queryData("selectPindekeTaskProductCount.do", "selectPindekeTaskProductList.do?randquery="+rand);
		}
	}
	...
	$(function() {
		var rand=Math.random() * (100001);
		MAOWU.page.init(${page.rowCount}, "selectPindekeTaskProductList.do?randIni="+rand);	
