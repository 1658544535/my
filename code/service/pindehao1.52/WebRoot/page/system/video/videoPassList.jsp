...
function del(val){
	...
	function goRefreshPage(result){
		...
		if(result=="1"){
			alert("删除成功");
			queryData("findVideoCount.do?os=2", "findVideoList.do?os=2&randdelete="+rand);
		}else{
			alert("删除失败");
		}
	}
...
<body>
<div class="sub_wrap">
<div class="s_nav"><a href="#">视频管理</a> &gt; <a href="#">已审核视频库</a></div>
...
<a  class='Add_btn' href='addVideo.do'>新增</a>
...
function query() {
	if(tt.validate()){
		var rand=Math.random() * ( 100000 + 1);
		queryData("findVideoCount.do?os=2", "findVideoList.do?os=2&randquery="+rand);
	}
}
	...
	function installPage() {
		$("#body").append(
			    ...
			    "<td>"+ this.type + "</td>"+
			    "<td>"+ this.score + "</td>"+
				"<td><a  class='edit_btn' href='updateVideoList.do?panduan=2&videoPojo.id="+this.id +"'>编辑</a>"+
	...
	$(function() {
		...
		MAOWU.page.init(<s:property value="page.rowCount"/>,
				"findVideoList.do?os=2&randIni="+rand);
