    ...
    $.ajax(
    {
        ...
        success: function (msg) {
        	...
        	if(val == 1){
        		...
        		$("#three").append("<option value=''>------</option>");
        	}
...
<div class="sub_wrap">
  ...
  <a href="goAddTaskLibraryList.do">添加任务</a>
  </div>
  <div class="h15"></div>
  <div>
  <form action="addTaskLibraryList.do" method="post" id="from1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table">
    <input type="hidden" name="taskPojo.id" value="${taskPojo.id}" class="floatLeft" id="taskId" />
    <input type="hidden" name="taskPojo.createName" value="${sessionScope.loginPojoId}">
    <tr>
	...
	<td><select id="taskType" name="taskPojo.taskType" class="floatLeft" onchange="setThree(this)">
		...
		<span id="title_taskTypeLink"></span></td>
	...
	<tr>
		...
		<td>
		<textarea rows=6  cols=30 name="taskPojo.taskContent" id="taskContent" class="floatLeft"/></textarea>	
...
<script>
	$(document).ready(function(){
		$("#sbutton").click(function(){	
		 ...
		 $("#three").append("<option value="+1+">看笔记</option>");
	});	
