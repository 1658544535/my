...
<div class="sub_wrap">
  ...
  <a href="goAddChildrenStory.do">儿童故事新增</a>
  </div>
  <div class="h15"></div>
  <div>
  <form action="addChildrenStory.do" method="post" id="from1" enctype="multipart/form-data">
    ...
    <tr>
		...
		<td width="55%">
			<textarea rows="10" cols="70" name="childrenStoryPojo.content" class="floatLeft" id="introduction"></textarea>
