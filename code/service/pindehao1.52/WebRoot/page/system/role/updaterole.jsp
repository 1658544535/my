...
<body>
<div class="sub_wrap">
  <div class="s_nav"><a>系统管理</a> &gt; <a href="store_list.html" >角色管理</a> &gt; <a href="#">修改角色</a></div>
  <div class="h15"></div>
  <div>
  <form action="updateRole.do" method="post" id="from1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_table">
      <tr>
        <td align="right" class="grey">票名称:</td>
        <td><input type="text" name="roleName"
						id="ticketName" value="<s:property	value="%{roleLists.roleName}"/>"><span id="ticketName_mgId"></span></td>
      
      </tr>
     
    </table>
 		<s:textfield name="roleId" value="%{roleLists.roleId}"  type="hidden"></s:textfield>
    </form>
  </div>
  <div class="Btn_div">
...
<script>
	var adName =new tt.Field("角色名称","roleName").setMsgId("ticketName_mgId");
