...
<form class="ui-form product-add-form"  action="updateProductFocusImagesSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }&productFocusImages.userId=${productFocusImagesPojo.userId}"  method="post" id="from1" enctype="multipart/form-data">	
                                ...
                                <div class="product-add-main">
                                        <fieldset>
                                            <div class="ui-form-item">
                                                ...
                                                <!--<img class="floatLeft" src="/upfiles/productFocusImages/${productFocusImagesPojo.images}" height="100px" /> <br/>
							                    ...
							                    <div class="uploadify" style="position:relative;height: 120px; width: 120px;border:1px solid #ddd;">
													...
													<div class="uploadPreview_img" style="">
														<img src="<s:i18n name="sysconfig"><s:text name="seller_dns" /></s:i18n>/upfiles/productFocusImages/${productFocusImagesPojo.images}" style="width:120px;height:120px;" />
													</div>
