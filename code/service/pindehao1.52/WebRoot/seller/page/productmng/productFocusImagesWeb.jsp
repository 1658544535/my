...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function del(val)
	{
		...
		{
			var url = "deleProductFocusImagesSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId}&productFocusImages.id="+val;	
			doOpreator(url,null);
		}else{
			return ;
		}
	...
	function goRefreshPage(result){
		...
		if(result=="1"){
			alert("删除成功");
			queryData("getProductFocusImagesCountSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }", "productFocusImagesAllListSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId}&randdelete="+rand,pageSize);
		}else{
			alert("删除失败");
		}
	}
                    ...
                    <div class="pure-u-1 main">
                        ...
                        <h1 class="seller-title">
                            ...
                            <div class="seller-title-head-more">
                                ...
                                <a class="ui-button ui-button-lgreen" href="goAddProductFocusImagesSellerWeb.do?productFocusImages.productId=${productFocusImages.productId }" >
                        ...
                        <div class="ui-table-container p20 martshow-index">
                         <form action="productFocusImagesDeleteIdSellerWeb.do?productFocusImages.productId=${productFocusImages.productId}" id="idform" method="post">
...
<script type="text/javascript">
	...
	function query() {
			var rand=Math.random() * ( 100000 + 1);
			queryData("getProductFocusImagesCountSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }", "productFocusImagesAllListSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }&randquery="+rand,pageSize);
	}
	...
	function installPage() {
		$("#body").append(
			    ...
			    "</td><td><a class='edit_btn' href='goFindProductFocusImagesSellerWeb.do?productFocusImages.id="+this.id +"&productFocusImages.userId=${productFocusImages.userId}'>编辑</a></br>"+
	...
	$(function() {
		 ...
		 MAOWU.page.init(<s:property value='page.rowCount'/>,
				 "productFocusImagesAllListSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }&randIni="+rand,pageSize);
