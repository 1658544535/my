			...
			<div id="content" class="wrapper">
                <div class="pure-g admin-wrapper">
                    <div class="pure-u-1 main">
                   	    <h1 class="seller-title" onclick="window.location.href='goAddressWeb.do'">
                           	 我的退货地址
                        </h1>
                        <div class="address">
                       		 <h2 class="add-tip">
                        ...
                        <div class="box">
                            <form action="updateAddressWeb.do" method="post" accept-charset="utf-8" id="seller-account-refund-address" class="ui-form">
                                <fieldset>
                                    <input type="hidden" name="deliveryAddressPojo1.id" value="${deliveryAddressPojo1.id}">
                                    <div class="ui-form-item">
                                        ...
                                        <select id="province" name="deliveryAddressPojo1.province" class="floatLeft" style="width: 150px;" value="deliveryAddressPojo1.province">                                                     
                                        </select>
                                        <select id="city" name="deliveryAddressPojo1.city" class="floatLeft" style="width: 120px;" value="deliveryAddressPojo1.city">
                                        </select>
                                        <select id="area" name="deliveryAddressPojo1.area" class="floatLeft" style="width: 120px;" value="deliveryAddressPojo1.area">
                                        </select>
                                        <br/>
                                    ...
                                    <div class="ui-form-item">
                                        ...
                                        <select name="deliveryAddressPojo1.isDefault" id="isDefault"  class="floatLeft">
												<option value="0" <s:if test="deliveryAddressPojo1.isDefault==0">selected="selected"</s:if>>否</option>
												<option value="1" <s:if test="deliveryAddressPojo1.isDefault==1">selected="selected"</s:if>>是</option>
												</select>
                                        <br/>
                                    ...
                                    <div class="ui-form-item">
                                        ...
                                        <button type="input" class="ui-button ui-button-lblue" onclick="window.history.back()">
                                        		返回
                                        </button>
                                    </div>
                                </fieldset>
