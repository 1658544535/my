...
<body>
    <div class="wraper">
    	<!-- <div class="w-title">
    		<h3 class="title">${userMakerBrandPojo.brandName}</h3>
    		<div class="info"></div>
    	</div> -->

    	<div class="w-img">
    		<!--<div class="img"><img src="<%=request.getContextPath() %>/upfiles/userMakerBrand/${userMakerBrandPojo.logo}" /></div>-->
    		<div class="info">${userMakerBrandPojo.content}</div>
    	</div>
    	
    	<div id="w-btn" class="w-btn">
    		<a href='{"type":"age","value":"${fn:trim(userMakerBrandPojo.ageType)}"}'>${userMakerBrandPojo.ageTypeStr}</a> 
    		<a href='{"type":"skill","value":"${fn:trim(userMakerBrandPojo.skillType)}"}'>${userMakerBrandPojo.skillTypeStr}</a> 
    		<a href='{"type":"product","value":"${fn:trim(userMakerBrandPojo.productType)}"}'>${userMakerBrandPojo.productTypeStr}</a> 
    		<a href='#'>${userMakerBrandPojo.optionTypeStr}</a> 
    	</div>
    </div>
