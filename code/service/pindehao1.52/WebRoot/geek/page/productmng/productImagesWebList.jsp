...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function del(val) {
		if(confirm("你真的想删除该记录么？")) {
			var url = "deleProductImagesGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&productImagesPojo.id="+val;	
			doOpreator(url,null);
		}else{
			return ;
		}
	...
	function goRefreshPage(result){
		...
		if(result=="1"){
			alert("删除成功");
			queryData("getCountProductImagesGeekWeb.do?productImagesPojo.productId=${productImagesPojo.productId}", "getProductImagesAllGeekWeb.do?productImagesPojo.productId=${productImagesPojo.productId}&page.rowCount=${page.rowCount}&randdelete="+rand,pageSize);
		}else{
			alert("删除失败");
		}
	}
	...
	function check(val) {
		if(confirm("确认要通过审核吗？")) {
			var url = "checkProductImagesGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&productImagesPojo.id="+val;	
	...
	function uncheck(val) {
		if(confirm("确认要取消审核吗？")) {
			var url = "unCheckProductImagesGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&productImagesPojo.id="+val;	
	...
	/*批量审核*/
	function checkAll() {
		$("#idform").attr("action","productImagescheckAllGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>");
		$("#idform").submit();
	}
	</script>
	<body>
                    ...
                    <div class="pure-u-1 main">
                        ...
                        <h1 class="seller-title">
                            ...
                            <div class="seller-title-head-more">
                                ...
                                <a class="ui-button ui-button-lgreen" href="goproductImagesAddGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>" >
                        ...
                        <form action="productImagesDeleteIdGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&productImagesPojo.userId=${productImagesPojo.userId}" id="idform" method="post">
...
<script type="text/javascript">
	...
	function query() {
			var rand=Math.random() * ( 100000 + 1);
			queryData("getCountProductImagesGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>", "getProductImagesAllGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&randquery="+rand,pageSize);
	}
	...
	//			"<a href='javascript:;' class='edit_btn' onclick=uncheck('"+this.id+"')>取消审核</a></br>"+			
				"<a class='edit_btn' href='goFindProductImagesGeekWeb.do?productImagesPojo.id="+this.id +"'>编辑</a></td></tr>");
	}
	...
	$(function() {
		 ...
		 MAOWU.page.init(<s:property value='page.rowCount'/>,
				 "getProductImagesAllGeekWeb.do?productImagesPojo.productId=<s:property value='productImagesPojo.productId'/>&randIni="+rand,pageSize);
