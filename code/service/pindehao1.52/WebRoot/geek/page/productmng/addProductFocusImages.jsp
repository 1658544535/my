...
<form class="ui-form product-add-form"  action="addProductFocusImagesSellerWeb.do?productFocusImages.productId=${productFocusImagesPojo.productId }&productFocusImages.userId=${productFocusImagesPojo.userId}"  method="post" id="from1" enctype="multipart/form-data">	
		<input type="hidden" name="productFocusImages.productId" id="productFocusImages.productId"
						value="${productFocusImages.productId}"/>
    ...
    <input type="hidden" name="productFocusImages2.userId" id="productFocusImages.userId"
						value="${productFocusImages.userId}"/>
                            ...
                            <div class="product-add-block view-BasisInfoDetail">
                                ...
                                <div class="product-add-main">
                                        <fieldset>
                                            <div class="ui-form-item">
                                                ...
                                                <p class="ui-form-text">
                                                 <!--<img  class="floatLeft" src="/upfiles/productFocusImages/${productFocusImagesPojo.images}" height="100px" />
						                         ...
						                         <div class="uploadify" style="position:relative;height: 120px; width: 120px;border:1px solid #ddd;">
													...
													<input type="file" name="upfile" id="ticketName" accept="image/png,image/gif,image/jpg,image/jpeg" class="uploadPreview_imgfile" style="position:absolute;width:100%;height:100%;left:0;top:0;opacity:0;z-index:3;filter:alpha(opacity=0);cursor:pointer;" />
												</div>
                                            ...
                                            <!--<div class="ui-form-item">
                                                ...
                                                <input class="ui-input" type="text" name="productFocusImages.alts" value="${productFocusImagesPojo.alts}" id="alts"> 
                                        ...
                                        <%--     <div class="ui-form-item">
                                                ...
                                                <input class="ui-input" type="text" name="productFocusImages.sorting" value="${productFocusImagesPojo.sorting}" id="sorting"> 
