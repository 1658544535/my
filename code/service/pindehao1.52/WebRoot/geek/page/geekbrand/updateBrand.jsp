        ...
        <div id="content" class="wrapper">
            <div class="pure-g admin-wrapper">
                <div class="pure-u-1 main">
                    ...
                    <form action="editGeekBrand.do" accept-charset="utf-8" class="ui-form p50"  method="post" enctype="multipart/form-data" id="from1">
                        <input type="hidden" name="userMakerBrandPojo.id" value="${userMakerBrandPojo.id}">
                        <input type="hidden" name="userBrandPojo.id" value="${userMakerBrandPojo.userBrandId}">
                        <input type="hidden" name="brandDicPojo.id" value="${userMakerBrandPojo.brandDicId}">
                        <div class="apply-box">
                            <div class="ui-form-item">
                                <label for="" class="ui-label">
                                    <span class="ui-form-required">*</span> 品牌名称
                                </label>
                                <input class="ui-input" name="userMakerBrandPojo.brandName" type="text" value="${userMakerBrandPojo.brandName}" />
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                               ...
                               <select name="userMakerBrandPojo.mainCategory" id="ticketType"  class="floatLeft">
								...
								<option value="${mainCategory.id}"<c:if test="${userMakerBrandPojo.mainCategory==mainCategory.id}">selected="selected" </c:if>>${mainCategory.name}</option>
							    </c:forEach>
				               </select>
				               </div>
				        </div>
                            ...
                            <div class="ui-form-item">
                                ...
                                <div class="fl picInfo">
                                    <div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        <p class="uploadPreview_note"  id="uploadPreview_note" style="width:120px;height:120px;line-height:120px;display:none;"><i class="iconfont">&#xf00f7;</i>暂无图片</p>
                                        <div class="uploadPreview_img"> 
											<img src="<s:i18n name="sysconfig"><s:text name="seller_dns" /></s:i18n>/upfiles/userMakerBrand/${userMakerBrandPojo.logo}" id="imgs" style="width:120px;height:120px;" />
										</div>
                            ...
                            <div class="ui-form-item">
                                ...
                                <div class="fl picInfo">
                                    <div class="uploadify main_img"style="position:relative;height: 120px; width: 120px;">
                                        <p class="uploadPreview_note"  id="uploadPreview_note" style="width:120px;height:120px;line-height:120px;display:none;"><i class="iconfont">&#xf00f7;</i>暂无图片</p>
                                        <div class="uploadPreview_img"> 
											<img src="<s:i18n name="sysconfig"><s:text name="seller_dns" /></s:i18n>/upfiles/userMakerBrand/${userMakerBrandPojo.registrationCertificate}" id="imgs" style="width:120px;height:120px;" />
										</div>
                        ...
                        <div class="apply-box">
                            <div class="ui-form-item">
                                ...
                                <!--编辑器-->
                                <script id="editor" type="text/plain" style="width:708px;height:400px;" name="userMakerBrandPojo.content">${userMakerBrandPojo.content}</script>
                            </div>
                        </div>
