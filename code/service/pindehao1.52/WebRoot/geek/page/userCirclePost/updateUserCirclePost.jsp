    ...
    <div class="wrap">
    	<div class="container" style="width:65%">
                <div class="pure-u-1 main">
                    <h1 class="seller-title">笔记管理/编辑笔记</h1>
                </div>
        </div>
		...
		<div class="container" style="width:65%">
			...
			<div class="tab-content">
			    <div role="tabpanel" class="tab-pane active" id="info">
					<div>
					<form action="updateUCPostGeek.do" id="form1" accept-charset="utf-8" class="ui-form p50 view-MartShowForm clone-MartShowForm" method="post"  enctype="multipart/form-data">
			...
			//判断是否添加了专题基本信息
			 if($("#specialId").val() == null || $("#specialId").val() == 0 || $("#specialId").val() == ""){
				//提交表单
				 $("#form1").ajaxSubmit({
		    			type: 'post', 
		                url: 'updateUCPostGeek.do', 
		                success: function(data) {
		                    if(data != null){
		                    	alert("基本信息保存成功！~请填写详情信息！~");
		                    	url="updateSpecialTemplatePageDataGeek.do?specialId="+data+"&dataId="+"${templatePageDataPojo.id}&pagetype=3";
		                    	$("#specialId").val(data);
		                    	$("#next").hide();
		                    }else{
		                    	alert("添加基本信息失败!");
