	    ...
	    <div class="">
	    	 <table border="0" cellpadding="0" cellspacing="0" width="100%" class="my_supplier_Product-R-list-table">
		            	<tr>
		                    ...
		                    <td class="my_supplier_Product-R-list-tableTit">总金额</td>
		                    <td class="my_supplier_Product-R-list-tableTit">应付金额</td>
		                    <td class="my_supplier_Product-R-list-tableTit">订单状态</td>
		                    <td class="my_supplier_Product-R-list-tableTit">下单时间</td>
		                    <td class="my_supplier_Product-R-list-tableTit">操作</td>
		                </tr>
		                <s:iterator value="webConsumerOrderList">
			    			<tr>
			    				<td>
				    			...
				    			<td>
					                <span class="DeliveryAddress-table-operation-L-Txt"><a href="goFindOrderWeb.do?order.id=<s:property value='id'/>&order.orderNo=<s:property value='orderNo'/>">退货</a></span>
				    			</td>
				            </tr>
						</s:iterator>
		      </table>
