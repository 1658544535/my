...
<script type="text/javascript">
	...
	function onTextblurpassword(){
		...
		if($("#password").val()==""){
			...
			$("#sysLogin_password_mgId").text("*为了您的信息安全，密码位数不能小于6位！");
			return false;
		}else if(!rstest.test($("#password").val())){
			$("#sysLogin_password_mgId").text("*密码不能有空格！");
			return false;
		}else{
...
<div id="main-nav">
        <div class="wrapper">
            ...
            <a href="goshopWeb.do" class="nav-item "> 店铺街</a>
	...
	<div class="register-schedule">
		<div class="register-schedule-L">验证账户信息</div>
		<div class="register-schedule-R">注册成功</div>
		<div class="clear"></div>
	...
	<div class="register-form">
		<form id="registerForm" action="doRegister.do" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td><input name="sysloginPojo.name" type="text" onfocus="javascript:onTextfocusNikename()" onblur="javascript:checkNikename()"
						class="register-form-tableInput" id="nikename" /><span id="sysLogin_name_mgId"></span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="" class="register-form-tableButton"><option>中国大陆</option></select><input
		...
		<div>
			<input type="button" id="btn_sure" value="立即注册"
