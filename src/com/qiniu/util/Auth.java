...
public final class Auth {
   ...
   */
  private static final String[] policyFields = new String[] {"callbackUrl", "callbackBody",
  ...
  private static void copyPolicy(final StringMap policy, StringMap originPolicy,
  ...
  String uploadTokenWithDeadline(String bucket, String key, long deadline, StringMap policy,
      boolean strict) {
    String scope = bucket;
    if (key != null) {
      scope = bucket + ":" + key;
