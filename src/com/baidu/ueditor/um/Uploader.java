...
public class Uploader {
      ...
      while (fii.hasNext()) {
        ...
        if (!fis.isFormField()) {
          ...
          if (originalName.toLowerCase().endsWith(".jpg")
            ...
            compressOriginal(file, this.getPhysicalPath(this.url));
          }
   ...
   * @return String
   */
  public void compressOriginal(File file, String path) {
    ...
    try {
      ...
      if (img.getWidth(null) == -1) {
        ...
        int newWidth = img.getWidth(null);// 输出的图片宽度
        int newHeight = img.getHeight(null); // 输出的图片高度
