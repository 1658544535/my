...
public class Signature {
  ...
  public static String getSign(Map<String, Object> map) {
    ...
    for (Map.Entry<String, Object> entry : map.entrySet()) {
      if ("wxtrade".equals(entry.getKey())) {
        wxtrade = String.valueOf(entry.getValue());
        continue;
      }
      if (entry.getValue() != "") {
   ...
   * @throws SAXException
   */
  public static String getSignFromResponseString(String responseString) throws IOException,
  ...
  public static boolean checkIsSignValidFromResponseString(String responseString) throws Exception {
    ...
    // Map<String,Object> map = XMLParser.getMapFromXML(responseString);
    Map<String, Object> map = XMLUtil.xml2Map(responseString);
   ...
   * @throws Exception
   */
  public static boolean checkIsSignValidFromResponseStringWithTrade(String responseString,
