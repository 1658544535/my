...
public class ScanPayService extends BaseService {
  ...
  public ScanPayService() throws IllegalAccessException, InstantiationException,
   ...
   * @throws Exception
   */
  public String jsrequest(ScanPayReqData scanPayReqData) throws Exception {

    // --------------------------------------------------------------------
    // 发送HTTPS的Post请求到API地址
    // --------------------------------------------------------------------
    String responseString = sendJSPost(scanPayReqData);
