...
public class ScanPayQueryService extends BaseService {
  ...
  public ScanPayQueryService() throws IllegalAccessException, InstantiationException,
   ...
   * @throws Exception
   */
  public String jsrequest(ScanPayQueryReqData scanPayQueryReqData) throws Exception {

    // --------------------------------------------------------------------
    // 发送HTTPS的Post请求到API地址
    // --------------------------------------------------------------------
    String responseString = sendJSPost(scanPayQueryReqData);
