...
public class BaseService {
  ...
  public BaseService(String api) throws ClassNotFoundException, IllegalAccessException,
   ...
   * 公众号支付调用
   */
  protected String sendJSPost(Object xmlObj) throws UnrecoverableKeyException, IOException,
      NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
    return serviceRequest.sendJSPost(apiURL, xmlObj);
  }
