...
public class ReverseService extends BaseService {
  ...
  public ReverseService() throws IllegalAccessException, InstantiationException,
   ...
   * @throws Exception
   */
  public String jsrequest(ReverseReqData reverseReqData) throws Exception {

    // --------------------------------------------------------------------
    // 发送HTTPS的Post请求到API地址
    // --------------------------------------------------------------------
    String responseString = sendJSPost(reverseReqData);
