...
public class DownloadBillService extends BaseService {
  ...
  public DownloadBillService() throws IllegalAccessException, InstantiationException,
   ...
   * @throws Exception
   */
  public String jsrequest(DownloadBillReqData downloadBillReqData) throws Exception {

    // --------------------------------------------------------------------
    // 发送HTTPS的Post请求到API地址
    // --------------------------------------------------------------------
    String responseString = sendJSPost(downloadBillReqData);
