...
public class DownloadBillBusiness {
  ...
  public DownloadBillBusiness() throws IllegalAccessException, ClassNotFoundException,
  ...
  public void run(DownloadBillReqData downloadBillReqData, ResultListener resultListener)
    ...
    try {
      ...
      downloadBillResData =
          (DownloadBillResData) Util.getObjectFromXML(downloadBillServiceResponseString,
      ...
      ReportReqData reportReqData =
          new ReportReqData(downloadBillReqData.getDevice_info(), Configure.DOWNLOAD_BILL_API,
              (int) totalTimeCost,// 本次请求耗时
              returnCode, returnMsg, "", "", "", "", Configure.getIP());
