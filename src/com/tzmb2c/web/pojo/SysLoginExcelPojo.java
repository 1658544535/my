 ...
 * @author EricChen
 */
public class SysLoginExcelPojo extends SuperPojo {
  ...
  @ExcelConf(headName = "用户ID", order = "1")
  public Long getId() {
    return id;
  }
  ...
  @ExcelConf(headName = "注册时间", order = "7")
  ...
  @ExcelConf(headName = "最后登录时间", order = "8")
  ...
  @ExcelConf(headName = "用户来源", order = "6")
